  ...
  return (
    <div className="rounded-lg border border-border bg-card p-4 space-y-3">
      <div className="flex items-center justify-between">
        <h3 className="text-sm font-semibold text-foreground">Integration Health (24h)</h3>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
        <div className="rounded border border-border p-2">
          ...
          <p className="text-sm font-semibold text-foreground">{msToSeconds(data.p95DurationMs)}</p>
        </div>
        <div className="rounded border border-border p-2">
          <p className="text-[11px] text-muted-foreground flex items-center gap-1">
          ...
          <p className="text-sm font-semibold text-foreground">{data.errorRatePct.toFixed(1)}%</p>
        </div>
        <div className="rounded border border-border p-2">
          <p className="text-[11px] text-muted-foreground flex items-center gap-1">
          ...
          <p className="text-sm font-semibold text-foreground">{data.stuckQueuedJobs}</p>
        </div>
        <div className="rounded border border-border p-2">
          <p className="text-[11px] text-muted-foreground flex items-center gap-1">
          ...
          <p className="text-sm font-semibold text-foreground">{data.deadLetteredJobs}</p>
        </div>
      </div>
