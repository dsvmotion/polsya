...
describe('AdminRoute', () => {
  it('shows loading state while checking ownership', () => {
    ...
    mockedUsePlatformOwnerStatus.mockReturnValue({ isOwner: false, isLoading: true } as unknown as ReturnType<typeof usePlatformOwnerStatus>);
  ...
  it('renders children when user is platform owner', () => {
    mockedUseAuth.mockReturnValue({ user: { id: '1' } } as unknown as ReturnType<typeof useAuth>);
    mockedUsePlatformOwnerStatus.mockReturnValue({ isOwner: true, isLoading: false } as unknown as ReturnType<typeof usePlatformOwnerStatus>);
  ...
  it('redirects non-owner users', () => {
    mockedUseAuth.mockReturnValue({ user: { id: '1' } } as unknown as ReturnType<typeof useAuth>);
    mockedUsePlatformOwnerStatus.mockReturnValue({ isOwner: false, isLoading: false } as unknown as ReturnType<typeof usePlatformOwnerStatus>);
