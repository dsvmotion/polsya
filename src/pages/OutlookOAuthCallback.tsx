...
import { useExchangeOutlookOAuth } from '@/hooks/useOutlookOAuth';
import { Button } from '@/components/ui/button';

export default function OutlookOAuthCallback() {
  const [searchParams] = useSearchParams();
  const navigate = useNavigate();
  const exchange = useExchangeOutlookOAuth();
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
        <div className="max-w-md w-full bg-white rounded-xl border border-gray-200 p-6 text-center space-y-3">
          ...
          <h1 className="text-lg font-semibold text-gray-900">Connecting Outlook</h1>
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
        <div className="max-w-md w-full bg-white rounded-xl border border-gray-200 p-6 text-center space-y-3">
          ...
          <h1 className="text-lg font-semibold text-gray-900">Outlook connected</h1>
