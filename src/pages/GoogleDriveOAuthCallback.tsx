    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center px-4">
        <div className="max-w-md w-full rounded-xl border border-border bg-card p-6 text-center space-y-3">
          ...
          <h1 className="text-lg font-semibold">Connecting Google Drive</h1>
          <p className="text-sm text-muted-foreground">Finalizing OAuth and storing your access token…</p>
        </div>
      </div>
    );
  }
  ...
  if (exchange.isError) {
    return (
      <div className="min-h-screen bg-background flex items-center justify-center px-4">
        <div className="max-w-md w-full rounded-xl border border-border bg-card p-6 text-center space-y-3">
          <XCircle className="h-8 w-8 text-destructive mx-auto" />
          <h1 className="text-lg font-semibold">Google Drive connection failed</h1>
    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center px-4">
        <div className="max-w-md w-full rounded-xl border border-border bg-card p-6 text-center space-y-3">
          ...
          <h1 className="text-lg font-semibold">Google Drive connected</h1>
